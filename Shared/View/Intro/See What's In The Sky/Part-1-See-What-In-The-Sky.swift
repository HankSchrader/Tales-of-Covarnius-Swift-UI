...
struct Part_1_See_What_In_The_Sky: View {
    ...
    var body: some View {
       ...
       let text =
        "Run away? No way, this is too good to miss!\n\nYou stop and look at the strange object descending slowly from the sky. As it gets closer, you see a strange creature inside, just behind the glass encasing. His complexion is green and he is about as tall as you are.\n\nButterflies fill your stomach. Maybe you should have ran while you had the chance..."
