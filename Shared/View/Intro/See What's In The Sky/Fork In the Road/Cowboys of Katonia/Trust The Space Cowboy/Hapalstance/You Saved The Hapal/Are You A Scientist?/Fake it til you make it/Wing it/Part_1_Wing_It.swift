...
struct Part_1_Wing_It: View {
    ...
    var body: some View {
        ...
        let storyView: StoryPayload = StoryPayload(text: text, image: isIPad ? "Covarnian Lab" : "Covarnian Lab iPhone", decision1: decision1, firstChoicePageName: firstChoicePageName)
