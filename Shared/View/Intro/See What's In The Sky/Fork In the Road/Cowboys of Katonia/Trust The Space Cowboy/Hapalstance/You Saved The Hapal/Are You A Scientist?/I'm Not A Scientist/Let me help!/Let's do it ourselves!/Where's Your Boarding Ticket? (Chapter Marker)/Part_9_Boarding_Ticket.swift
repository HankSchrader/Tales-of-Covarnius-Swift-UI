...
struct Part_10_Boarding_Ticket: View {
    ...
    var body: some View {
        let text =
        "“How?” you ask. You realize the plan did not include Chrono.\n\nChrono raises his device triumphantly into the air. “This is an autoparker.”\n\n“A what?” you reply.\n\n“An autoparker. I just type in our coordinates and our space shuttle will automatically arrive. All we need to do is schedule it to arrive right here,” he says. “That spacecraft is equipped with mega ion engines. It will crash through the ship's wall and we’ll be able to escape.” The plan sounds dangerous, and probably won’t work.\n\n“Just one button push away from freedom!” Chrono exclaims. \"So what should we do?"
        ...
        let storyView: StoryPayload = StoryPayload(text: text, image: Constants.isIPad ? "Brig" : "Brig iPhone", decision1: decision1, firstChoicePageName: firstChoicePageName, secondChoicePageName: secondChoicePageName, decision2: decision2)
        return DisplayView(showMenu: self.$showMenu, view: storyView)
    }
}
