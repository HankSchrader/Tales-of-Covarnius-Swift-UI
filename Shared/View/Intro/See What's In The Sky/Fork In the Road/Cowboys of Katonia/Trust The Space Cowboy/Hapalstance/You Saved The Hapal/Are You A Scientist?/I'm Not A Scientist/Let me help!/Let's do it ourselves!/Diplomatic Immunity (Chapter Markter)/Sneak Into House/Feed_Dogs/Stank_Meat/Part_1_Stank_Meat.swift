...
struct Part_1_Stank_Meat: View {
    ...
    var body: some View {
        ...
        let storyView: StoryPayload = StoryPayload(text: text, image: Constants.isIPad ? "Stank Meat" : "Stank Meat iPhone", decision1: decision1, firstChoicePageName: firstChoicePageName)
