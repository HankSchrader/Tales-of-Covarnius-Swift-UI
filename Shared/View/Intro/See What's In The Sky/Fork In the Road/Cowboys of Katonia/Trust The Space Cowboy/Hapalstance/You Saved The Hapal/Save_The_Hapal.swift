...
struct Part_1_Save_The_Hapal: View {
    ...
    var body: some View {
        ...
        let storyView: StoryPayload = StoryPayload(text: text, image: Constants.isIPad ? "Hapal" : "Hapal iPhone", decision1: decision1, firstChoicePageName: firstChoicePageName)
