...
struct Part_5_Fetch_Key: View {
    ...
    var body: some View {
       let text =
        ...
        let storyView: StoryPayload = StoryPayload(text: text, image: "Invasion", decision1: decision1, firstChoicePageName: firstChoicePageName, secondChoicePageName: secondChoicePageName, decision2: decision2)
