...
struct Part_1_Boarding_Ticket: View {
    ...
    var body: some View {
        ...
        let storyView: StoryPayload = StoryPayload(text: text, image: isIPad ? "Ambassador Key Card iPad" : "Ambassador Key Card", decision1: decision1, firstChoicePageName: firstChoicePageName)
