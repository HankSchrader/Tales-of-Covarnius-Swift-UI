...
struct Part_3_Stank_Meat: View {
    ...
    var body: some View {
        ...
        let storyView: StoryPayload = StoryPayload(text: text, image: Constants.isIPad ? "Covarnian Cruiser" : "Covarnian Cruiser iPhone 2", decision1: decision1, firstChoicePageName: firstChoicePageName)
