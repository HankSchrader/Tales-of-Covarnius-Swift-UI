...
struct Part_3_Stank_Meat: View {
    ...
    var body: some View {
        let text = "You, Chrono, and your faithful companion Luna make your way to a large lot extending behind and to the side of the council chamber. Covarnian Cruisers are parked in neat rows, each one shiny and perfect. “Which one goes with our key card?” you ask worriedly as you survey the dozens and dozens of ships in the lot.\n\n“Don’t worry,” Chrono says with a smile. “These key cards are designed to be used in any of the cruisers.”"
