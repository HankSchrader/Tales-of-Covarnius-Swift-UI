...
struct Part_7_Gravity_Gun: View {
    ...
    var body: some View {
        ...
        let storyView: StoryPayload = StoryPayload(text: text, image: Constants.isIPad ? "Toilet Cloud" : "Toilet Cloud iPhone", decision1: decision1, firstChoicePageName: firstChoicePageName)
