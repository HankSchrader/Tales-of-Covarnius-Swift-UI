...
struct Part_1_Feed_Dogs: View {
    ...
    var body: some View {
        ...
        let storyView: StoryPayload = StoryPayload(text: text, image: Constants.isIPad ? "3 foods iPad" : "3 foods", decision1: decision1, firstChoicePageName: firstChoicePageName)
