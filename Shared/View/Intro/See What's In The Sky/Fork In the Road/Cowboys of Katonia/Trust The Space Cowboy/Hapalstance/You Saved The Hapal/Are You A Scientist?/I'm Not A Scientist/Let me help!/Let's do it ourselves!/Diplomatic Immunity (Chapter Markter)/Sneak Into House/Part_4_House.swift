...
struct Part_4_House: View {
    ...
    var body: some View {
        ...
        let secondChoicePageName = Part_3_They_Are_Vicious.PageName
        let storyView: StoryPayload = StoryPayload(text: text, image: Constants.isIPad ? "Growlics iPad" : "Growlics", decision1: decision1, firstChoicePageName: firstChoicePageName, secondChoicePageName: secondChoicePageName, decision2: decision2)
