...
struct Part_4_Cowboys_Of_Katonia: View {
    ...
    var body: some View {
        ...
        let storyView: StoryPayload = StoryPayload(text: text, image: isIPad ? "Crash Land" : "Crash Land iPhone", decision1: decision1, firstChoicePageName: firstChoicePageName)
