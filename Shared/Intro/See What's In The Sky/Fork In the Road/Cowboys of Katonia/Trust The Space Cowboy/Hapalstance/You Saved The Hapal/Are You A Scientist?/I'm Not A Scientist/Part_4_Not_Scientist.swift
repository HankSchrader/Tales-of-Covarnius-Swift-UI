...
struct Part_4_Not_Scientist: View {
    var body: some View {
        ...
        getPageView(mainText: text, firstChoice: AnyView(Part_1_Warmongers()), decision1: "Warmongers you say? I'm outta here.", secondChoice: AnyView(Part_1_Let_Me_Help()), decision2: "Let me help!")
    }
}
