...
struct Part_4_Not_Scientist: View {
    var body: some View {
        ...
        getPageView(mainText: text, firstChoice: AnyView(Part_1_Outta_Here()), decision1: "Warmongers you say? I'm outta here.", secondChoice: AnyView(Part_4_Not_Scientist()), decision2: "Never give up! We can do this.")
    }
}
