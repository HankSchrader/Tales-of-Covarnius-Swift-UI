...
struct Part_3_Keep_Thinking: View {
    var body: some View {
        ...
        getPageView(mainText: text, firstChoice: AnyView(Part_1_Two_Diplomats()), decision1: "Do as they ask.", secondChoice: AnyView(Part_1_Luna()), decision2: "I'm not leaving Luna behind.")
