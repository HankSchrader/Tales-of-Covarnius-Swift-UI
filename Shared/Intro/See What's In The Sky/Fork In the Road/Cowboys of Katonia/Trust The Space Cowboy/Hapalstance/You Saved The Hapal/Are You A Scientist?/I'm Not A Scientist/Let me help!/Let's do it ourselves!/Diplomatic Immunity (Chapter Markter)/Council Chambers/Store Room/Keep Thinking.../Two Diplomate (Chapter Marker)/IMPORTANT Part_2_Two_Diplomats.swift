...
struct Part_2_Two_Diplomats: View {
    var body: some View {
        ...
        getPageView(mainText: text, firstChoice: AnyView(Part_1_Two_Diplomats()), decision1: "Don't take it! Far too risky...", secondChoice: AnyView(Part_1_Luna()), decision2: "Take the key.")
    }
}
